...
- CRM
- random
excerpt: Local public sector is uniquely positioned to share expertise, solution designs
  and code because there are hundreds of organisations with similar requirements operating
  non-competitively within the same statutory framework.
author: John Latham
header:
